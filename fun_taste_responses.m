function sig_neurons = fun_taste_responses(neurons, tastes, binnedC, binnedC2, baseline, comparison)
pval3=NaN(length(tastes),length(neurons));
x=[];
idx=1;
...
fprintf(append('Number of responsive neurons: ', num2str(length(sig_neurons)), '/',num2str(length(neurons)),'\n'))
