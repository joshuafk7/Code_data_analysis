...
neuron = Sources2D(); 
cd D:\Behavior\Discrimination\Imaging\JK062\190925\cropped2\MC
nams = {'1_JK062_MC_crop.tif','2_JK062_MC_crop.tif','3_JK062_MC_crop.tif','4_JK062_MC_crop.tif'};          % you can put all file names into a cell array; when it's empty, manually select files 
...
pars_envs = struct('memory_size_to_use', 16, ...   % GB, memory space you allow to use in MATLAB 
    ...
    'batch_frames', 4109);           % number of frames per batch 
  % -------------------------      SPATIAL      -------------------------  %
