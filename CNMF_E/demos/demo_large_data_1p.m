...
%% choose data
neuron = Sources2D();
cd D:\Behavior\Discrimination\Imaging\JK063\JK063\190925
nam = get_fullname('JK063_MC_crop.tif');          % this demo data is very small, here we just use it as an example
