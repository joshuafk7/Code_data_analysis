...
function [tastes,unit, data,trial, summary] = process_intan_v2_behavior_only(filename);
...
thr = .5;
[data.centSp,~] = Timing_onset_offset(dataRaw.analog(1,:), dataRaw.ts, thr,30,0); % get the central licks
[data.LeftSp,~] = Timing_onset_offset(dataRaw.analog(2,:), dataRaw.ts, thr,30,0);
[data.RightSp,~] = Timing_onset_offset(dataRaw.analog(3,:), dataRaw.ts, thr,30,0);
...
[data.T_1,~]     = Timing_onset_offset(dataRaw.event(1,:), dataRaw.ts, 0.5,30,0);
...
[data.R_1, ~]            = Timing_onset_offset(dataRaw.event(8,:), dataRaw.ts, 0.5,3000,0);
[data.L_1, ~]            = Timing_onset_offset(dataRaw.event(9,:), dataRaw.ts, 0.5,3000,0);
