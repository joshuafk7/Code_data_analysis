...
function [tastes,unit, data,trial, summary] = process_intan_decision_making(file,excel_tastes,excel_directions)
% file = dir('*.rhd');
...
% [data.Forward(1,:),data.Forward(2,:)]              = Timing_onset_offset(dataRaw.event(9,:), dataRaw.ts, 0.5,3000,0);
[data.Backward(1,:),data.Backward(2,:)]              = Timing_onset_offset(dataRaw.event(12,:), dataRaw.ts, 0.5,30,0);
% [data.Up(1,:),data.Up(2,:)]                        = Timing_onset_offset(dataRaw.event(10,:), dataRaw.ts, 0.5,30,0);
...
[data.R_1(1,:), data.R_1(2,:)]            = Timing_onset_offset(dataRaw.event(7,:), dataRaw.ts, 0.5,30,0);

[data.L_1(1,:), data.L_1(2,:)]            = Timing_onset_offset(dataRaw.event(8,:), dataRaw.ts, 0.5,30,0);   
